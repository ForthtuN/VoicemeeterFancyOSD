...
The program is portable, no installation is required, but you need [.NET 10 Desktop Runtime](https://dotnet.microsoft.com/download/dotnet/10.0) (click '*Download x64*' under '*Run desktop apps*') **or alternatively** you may install the runtime via Command Prompt with the following command:
...
# Build instructions
[.NET 10.0](https://dotnet.microsoft.com/download/dotnet/10.0) WPF project
